...
(function (root) {
    var CoffeeScript = function () {
        ...
        require['./helpers'] = (function () {
            ...
            (function () {
                ...
                syntaxErrorToString = function () {
                    var codeLine, colorize, colorsEnabled, end, filename, first_column, first_line, last_column,
                        last_line, marker, ref1, ref2, ref3, ref4, start;
        ...
        require['./rewriter'] = (function () {
            ...
            // Generated by CoffeeScript 1.12.2
            (function () {
                var BALANCED_PAIRS, CALL_CLOSERS, EXPRESSION_CLOSE, EXPRESSION_END, EXPRESSION_START, IMPLICIT_CALL,
                    IMPLICIT_END, IMPLICIT_FUNC, IMPLICIT_UNSPACED_CALL, INVERSES, LINEBREAKS, SINGLE_CLOSERS,
                    SINGLE_LINERS, generate, k, left, len, ref, rite,
                ...
                exports.Rewriter = (function () {
                    ...
                    Rewriter.prototype.addImplicitBracesAndParens = function () {
                        ...
                        return this.scanTokens(function (token, i, tokens) {
                            var endImplicitCall, endImplicitObject, forward, inImplicit, inImplicitCall,
                                inImplicitControl, inImplicitObject, newLine, nextTag, offset, prevTag, prevToken, ref,
                                ref1, ref2, ref3, ref4, ref5, s, sameLine, stackIdx, stackTag, stackTop, startIdx,
                                startImplicitCall, startImplicitObject, startsLine, tag;
                            tag = token[0];
        ...
        require['./lexer'] = (function () {
            ...
            // Generated by CoffeeScript 1.12.2
            (function () {
                var BOM, BOOL, CALLABLE, CODE, COFFEE_ALIASES, COFFEE_ALIAS_MAP, COFFEE_KEYWORDS, COMMENT, COMPARE,
                    COMPOUND_ASSIGN, HERECOMMENT_ILLEGAL, HEREDOC_DOUBLE, HEREDOC_INDENT, HEREDOC_SINGLE, HEREGEX,
                    HEREGEX_OMIT, HERE_JSTOKEN, IDENTIFIER, INDENTABLE_CLOSERS, INDEXABLE, INVALID_ESCAPE, INVERSES,
                    JSTOKEN, JS_KEYWORDS, LEADING_BLANK_LINE, LINE_BREAK, LINE_CONTINUER, Lexer, MATH, MULTI_DENT,
                    NOT_REGEX, NUMBER, OPERATOR, POSSIBLY_DIVISION, REGEX, REGEX_FLAGS, REGEX_ILLEGAL, RELATION,
                    RESERVED, Rewriter, SHIFT, SIMPLE_STRING_OMIT, STRICT_PROSCRIBED, STRING_DOUBLE, STRING_OMIT,
                    STRING_SINGLE, STRING_START, TRAILING_BLANK_LINE, TRAILING_SPACES, UNARY, UNARY_MATH, VALID_FLAGS,
                    WHITESPACE, compact, count, invertLiterate, isForFrom, isUnassignable, key, locationDataToString,
                    ref, ref1, repeat, starts, throwSyntaxError,
                    indexOf = [].indexOf || function (item) {
                        for (var i = 0, l = this.length; i < l; i++) {
                            if (i in this && this[i] === item) return i;
                        }
                ...
                exports.Lexer = Lexer = (function () {
                    ...
                    Lexer.prototype.identifierToken = function () {
                        var alias, colon, colonOffset, id, idLength, input, match, poppedToken, prev, ref2, ref3, ref4,
                            ref5, ref6, ref7, tag, tagToken;
                    ...
                    Lexer.prototype.stringToken = function () {
                        var $, attempt, delimiter, doc, end, heredoc, i, indent, indentRegex, match, quote, ref2, ref3,
                            regex, token, tokens;
                    ...
                    Lexer.prototype.matchWithInterpolations = function (regex, delimiter) {
                        var close, column, firstToken, index, lastToken, line, nested, offsetInChunk, open, ref2, ref3,
                            ref4, str, strPart, tokens;
                        tokens = [];
                    ...
                    Lexer.prototype.mergeInterpolationTokens = function (tokens, options, fn) {
                        var converted, firstEmptyStringIndex, firstIndex, i, j, lastToken, len, locationToken, lparen,
                            plusToken, ref2, rparen, tag, token, tokensToPush, value;
                        if (tokens.length > 1) {
...
*/
            var parser = (function () {
                var o = function (k, v, o, l) {
                        ...
                        return o
                    }, $V0 = [1, 22], $V1 = [1, 25], $V2 = [1, 83], $V3 = [1, 79], $V4 = [1, 84], $V5 = [1, 85],
                    $V6 = [1, 81], $V7 = [1, 82], $V8 = [1, 56], $V9 = [1, 58], $Va = [1, 59], $Vb = [1, 60],
                    $Vc = [1, 61], $Vd = [1, 62], $Ve = [1, 49], $Vf = [1, 50], $Vg = [1, 32], $Vh = [1, 68],
                    $Vi = [1, 69], $Vj = [1, 78], $Vk = [1, 47], $Vl = [1, 51], $Vm = [1, 52], $Vn = [1, 67],
                    $Vo = [1, 65], $Vp = [1, 66], $Vq = [1, 64], $Vr = [1, 42], $Vs = [1, 48], $Vt = [1, 63],
                    $Vu = [1, 73], $Vv = [1, 74], $Vw = [1, 75], $Vx = [1, 76], $Vy = [1, 46], $Vz = [1, 72],
                    $VA = [1, 34], $VB = [1, 35], $VC = [1, 36], $VD = [1, 37], $VE = [1, 38], $VF = [1, 39],
                    $VG = [1, 86], $VH = [1, 6, 32, 42, 131], $VI = [1, 101], $VJ = [1, 89], $VK = [1, 88],
                    $VL = [1, 87], $VM = [1, 90], $VN = [1, 91], $VO = [1, 92], $VP = [1, 93], $VQ = [1, 94],
                    $VR = [1, 95], $VS = [1, 96], $VT = [1, 97], $VU = [1, 98], $VV = [1, 99], $VW = [1, 100],
                    $VX = [1, 104],
                    ...
                    $VZ = [2, 165], $V_ = [1, 110], $V$ = [1, 111], $V01 = [1, 112], $V11 = [1, 113], $V21 = [1, 115],
                    $V31 = [1, 116], $V41 = [1, 109], $V51 = [1, 6, 32, 42, 131, 133, 135, 139, 156], $V61 = [2, 27],
                    $V71 = [1, 123], $V81 = [1, 121],
                    ...
                    $Vc1 = [2, 73], $Vd1 = [1, 128], $Ve1 = [1, 133], $Vf1 = [1, 134], $Vg1 = [1, 136],
                    ...
                    $Vk1 = [2, 63], $Vl1 = [1, 166], $Vm1 = [1, 178], $Vn1 = [1, 180], $Vo1 = [1, 175], $Vp1 = [1, 182],
                    $Vq1 = [1, 184],
                    ...
                    $Vv1 = [40, 41, 114], $Vw1 = [1, 241], $Vx1 = [1, 240],
                    $Vy1 = [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 156],
                    $Vz1 = [2, 71], $VA1 = [1, 250], $VB1 = [6, 31, 32, 65, 70], $VC1 = [6, 31, 32, 55, 65, 70, 73],
                    $VD1 = [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 156, 159, 160, 164, 166, 167, 168, 169, 170, 171, 172, 173, 174],
                    $VE1 = [40, 41, 82, 83, 84, 85, 87, 90, 113, 114], $VF1 = [1, 269], $VG1 = [2, 62], $VH1 = [1, 279],
                    $VI1 = [1, 281], $VJ1 = [1, 286], $VK1 = [1, 288], $VL1 = [2, 186],
                    ...
                    $VN1 = [1, 297], $VO1 = [6, 31, 32, 70, 115, 120],
                    ...
                    $VS1 = [146, 147, 148], $VT1 = [70, 146, 147, 148], $VU1 = [6, 31, 94], $VV1 = [1, 311],
                    $VW1 = [6, 31, 32, 70, 94], $VX1 = [6, 31, 32, 58, 70, 94], $VY1 = [6, 31, 32, 55, 58, 70, 94],
                    ...
                    $V$1 = [2, 175], $V02 = [6, 31, 32], $V12 = [2, 72], $V22 = [1, 323], $V32 = [1, 324],
                    ...
                    $V52 = [32, 151, 153], $V62 = [1, 6, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 134, 140, 156],
                    $V72 = [1, 350], $V82 = [1, 356], $V92 = [1, 6, 32, 42, 131, 156], $Va2 = [2, 86], $Vb2 = [1, 366],
                    $Vc2 = [1, 367],
                    ...
                    $Vf2 = [1, 380], $Vg2 = [1, 381], $Vh2 = [6, 31, 32, 94], $Vi2 = [6, 31, 32, 70],
                    ...
                    $Vk2 = [31, 70], $Vl2 = [1, 407], $Vm2 = [1, 408], $Vn2 = [1, 414], $Vo2 = [1, 415];
                var parser = {
                    ...
                    table: [{
                        ...
                        161: $VE,
                        162: $VF
                    }, {1: [3]}, {1: [2, 2], 6: $VG}, o($VH, [2, 3]), o($VH, [2, 6], {
                        141: 77,
                        132: 102,
                        138: 103,
                        133: $Vu,
                        ...
                        162: [1, 147],
                        175: [1, 148]
                    }), o($VY, [2, 244], {151: [1, 150]}), {30: 151, 31: $Vg1}, {
                        30: 152,
                        31: $Vg1
                    }, o($VY, [2, 208]), {30: 153, 31: $Vg1}, {
                        7: 154,
                        8: 122,
                        10: 20,
                        11: 21,
                        ...
                        144: [1, 192],
                        145: 193
                    }, {142: 198, 146: [1, 199], 147: [1, 200], 148: [1, 201]}, o([6, 31, 70, 94], $Vs1, {
                        39: 80,
                        93: 202,
                        56: 203,
                        57: 204,
                        ...
                        110: 231,
                        114: $Vq1
                    }, o($Vr1, [2, 88]), o($Vv1, [2, 166]), {35: 232, 36: $Vp1}, {
                        35: 233,
                        36: $Vp1
                    }, o($Vr1, [2, 103], {35: 234, 36: $Vp1}), {35: 235, 36: $Vp1}, o($Vr1, [2, 104]), {
                        7: 237,
                        8: 122,
                        10: 20,
                        11: 21,
                        ...
                        161: $VE,
                        162: $VF
                    }, {86: 242, 87: $V21, 90: $V31}, {110: 243, 114: $Vq1}, o($Vr1, [2, 89]), o($VH, [2, 65], {
                        15: 7,
                        16: 8,
                        17: 9,
                        18: 10,
                        ...
                        161: $VE,
                        162: $VF
                    }, {30: 261, 31: $Vg1, 155: [1, 262]}, o($VY, [2, 191], {
                        126: 263,
                        127: [1, 264],
                        128: [1, 265]
                        ...
                        173: $VV,
                        174: $VW
                    }, {150: 267, 152: 268, 153: $VF1}, o($VY, [2, 116]), {
                        7: 270,
                        8: 122,
                        10: 20,
                        11: 21,
                        ...
                        173: $VV,
                        174: $VW
                    }), o($V51, [2, 123]), {29: [1, 273], 70: [1, 274]}, {29: [1, 275]}, {
                        31: $VH1,
                        33: 280,
                        34: $V2,
                        94: [1, 276],
                        ...
                        173: $VV,
                        174: $VW
                    }), o($VM1, [2, 172]), o([6, 31, 120], $Vz1, {69: 296, 70: $VN1}), o($VO1, [2, 181]), {
                        7: 254,
                        8: 122,
                        10: 20,
                        11: 21,
                        ...
                        113: $V41,
                        114: $VZ
                    }, o($VE1, $Vi1), {6: $VG, 42: [1, 315]}, o($VH, [2, 4]), o($VZ1, [2, 257], {
                        141: 77,
                        132: 102,
                        138: 103,
                        163: $VL,
                        ...
                        173: $VV,
                        174: $VW
                    }), o($V42, [2, 30]), {6: $VG, 32: [1, 327]}, o($Vy1, [2, 270], {
                        141: 77,
                        132: 102,
                        138: 103,
                        159: $VJ,
                        ...
                        161: $VE,
                        162: $VF
                    }, o($VY, [2, 192], {127: [1, 331]}), {30: 332, 31: $Vg1}, {
                        30: 335,
                        31: $Vg1,
                        33: 333,
                        34: $V2,
                        ...
                        161: $VE,
                        162: $VF
                    }, {39: 344, 40: $V4, 41: $V5}, {92: [1, 346], 99: 345, 104: $Vl1}, {
                        39: 347,
                        40: $V4,
                        41: $V5
                    }, {29: [1, 348]}, o($VU1, $Vz1, {69: 349, 70: $V72}), o($VW1, [2, 130]), {
                        31: $VH1,
                        33: 280,
                        34: $V2,
                        100: 351,
                        ...
                        33: 354,
                        34: $V2
                    }, o($V51, [2, 141]), o($VU1, $Vz1, {69: 355, 70: $V82}), o($VW1, [2, 150]), {
                        31: $VJ1,
                        33: 287,
                        34: $V2,
                        103: $VK1,
                        ...
                        173: $VV,
                        174: $VW
                    }), {39: 362, 40: $V4, 41: $V5}, o($V91, [2, 199]), {6: $VG, 32: [1, 363]}, {
                        7: 364,
                        8: 122,
                        10: 20,
                        11: 21,
                        ...
                        70: $Va2,
                        120: $Va2
                    }), {6: $Vb2, 31: $Vc2, 120: [1, 365]}, o([6, 31, 32, 115, 120], $V12, {
                        15: 7,
                        16: 8,
                        17: 9,
                        18: 10,
                        ...
                        161: $VE,
                        162: $VF
                    }), o($V02, $Vz1, {69: 369, 70: $VN1}), o($Vb1, [2, 167]), o([6, 31, 115], $Vz1, {
                        69: 370,
                        70: $VN1
                    }), o($Vd2, [2, 242]), {
                        7: 371,
                        ...
                        173: $VV,
                        174: $VW
                    }), {6: $Vf2, 31: $Vg2, 94: [1, 379]}, o($Vh2, $V12, {
                        39: 80,
                        57: 204,
                        59: 205,
                        11: 206,
                        ...
                        173: $VV,
                        174: $VW
                    }, {30: 394, 31: $Vg1}, o($VY, [2, 193]), {30: 395, 31: $Vg1}, {
                        30: 396,
                        31: $Vg1
                    }, o($Vj2, [2, 197]), {
                        32: [1, 397],
                        ...
                        152: 339,
                        153: $VF1
                    }, o($VY, [2, 236]), {30: 399, 31: $Vg1}, o($V52, [2, 239]), {
                        30: 400,
                        31: $Vg1,
                        70: [1, 401]
                    }, o($Vk2, [2, 189], {
                        ...
                        101: 278,
                        103: $VI1
                    }, o($V51, [2, 125]), {39: 405, 40: $V4, 41: $V5}, {
                        6: $Vl2,
                        31: $Vm2,
                        94: [1, 406]
                    }, o($Vh2, $V12, {33: 280, 101: 409, 34: $V2, 103: $VI1}), o($V02, $Vz1, {
                        69: 410,
                        70: $V72
                    }), {33: 411, 34: $V2}, {33: 412, 34: $V2}, {29: [2, 140]}, {
                        6: $Vn2,
                        31: $Vo2,
                        94: [1, 413]
                    }, o($Vh2, $V12, {33: 287, 108: 416, 34: $V2, 103: $VK1}), o($V02, $Vz1, {
                        69: 417,
                        70: $V82
                    }), {33: 418, 34: $V2, 103: [1, 419]}, o($V92, [2, 144], {
                        141: 77,
                        132: 102,
                        138: 103,
                        133: $Vu,
                        ...
                        161: $VE,
                        162: $VF
                    }, o($VO1, [2, 182]), {6: $Vb2, 31: $Vc2, 32: [1, 426]}, {
                        6: $Vb2,
                        31: $Vc2,
                        115: [1, 427]
                    }, o($VR1, [2, 202], {
                        ...
                        161: $VE,
                        162: $VF
                    }, o($VY, [2, 122]), {39: 441, 40: $V4, 41: $V5}, o($VU1, $Vz1, {
                        69: 442,
                        70: $V72
                    }), o($V51, [2, 126]), {29: [1, 443]}, {33: 280, 34: $V2, 101: 444, 103: $VI1}, {
                        31: $VH1,
                        33: 280,
                        34: $V2,
                        100: 445,
                        ...
                        103: $VK1,
                        108: 448
                    }, {31: $VJ1, 33: 287, 34: $V2, 103: $VK1, 106: 449, 108: 285}, o($VW1, [2, 151]), {
                        6: $Vn2,
                        31: $Vo2,
                        32: [1, 450]
                        ...
                        173: $VV,
                        174: $VW
                    }), o($VW1, [2, 113]), o($V02, $Vz1, {69: 455, 70: $VV1}), {
                        32: [1, 456],
                        132: 102,
                        133: $Vu,
                        135: $Vv,
                        ...
                        173: $VV,
                        174: $VW
                    }), o($V51, [2, 128]), {6: $Vl2, 31: $Vm2, 94: [1, 460]}, {
                        39: 461,
                        40: $V4,
                        41: $V5
                    }, o($VW1, [2, 132]), o($V02, $Vz1, {69: 462, 70: $V72}), o($VW1, [2, 133]), {
                        39: 463,
                        40: $V4,
                        41: $V5
                        ...
                        69: 464,
                        70: $V82
                    }), o($VW1, [2, 153]), o($V51, [2, 146]), {6: $Vb2, 31: $Vc2, 32: [1, 465]}, {
                        7: 466,
                        8: 122,
                        10: 20,
                        11: 21,
                    ...
                    parse: function parse(input) {
                        var self = this, stack = [0], tstack = [], vstack = [null], lstack = [], table = this.table,
        ...
        require['./nodes'] = (function () {
            ...
            // Generated by CoffeeScript 1.12.2
            (function () {
                var Access, Arr, Assign, Base, Block, BooleanLiteral, Call, Class, Code, CodeFragment, Comment,
                    Existence, Expansion, ExportAllDeclaration, ExportDeclaration, ExportDefaultDeclaration,
                    ExportNamedDeclaration, ExportSpecifier, ExportSpecifierList, Extends, For, IdentifierLiteral, If,
                    ImportClause, ImportDeclaration, ImportDefaultSpecifier, ImportNamespaceSpecifier, ImportSpecifier,
                    ImportSpecifierList, In, Index, InfinityLiteral, JS_FORBIDDEN, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST,
                    LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, ModuleDeclaration, ModuleSpecifier, ModuleSpecifierList,
                    NEGATE, NO, NaNLiteral, NullLiteral, NumberLiteral, Obj, Op, Param, Parens, PassthroughLiteral,
                    PropertyName, Range, RegexLiteral, RegexWithInterpolations, Return, SIMPLENUM, Scope, Slice, Splat,
                    StatementLiteral, StringLiteral, StringWithInterpolations, SuperCall, Switch, TAB, THIS,
                    TaggedTemplateCall, ThisLiteral, Throw, Try, UTILITIES, UndefinedLiteral, Value, While, YES,
                    YieldReturn, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText,
                    isComplexOrAssignable, isLiteralArguments, isLiteralThis, isUnassignable, locationDataToString,
                    merge, multident, ref1, ref2, some, starts, throwSyntaxError, unfoldSoak, utility,
                ...
                exports.Range = Range = (function (superClass1) {
                    ...
                    Range.prototype.compileNode = function (o) {
                        var cond, condPart, from, gt, idx, idxName, known, lt, namedIndex, ref3, ref4, stepPart, to,
                            varPart;
                        if (!this.fromVar) {
                    ...
                    Range.prototype.compileArray = function (o) {
                        var args, body, cond, hasArgs, i, idt, j, known, post, pre, range, ref3, ref4, result, results,
                            vars;
                        known = (this.fromNum != null) && (this.toNum != null);
                ...
                exports.Obj = Obj = (function (superClass1) {
                    ...
                    Obj.prototype.compileNode = function (o) {
                        var answer, dynamicIndex, hasDynamic, i, idt, indent, j, join, k, key, l, lastNoncom, len1,
                            len2, len3, node, oref, prop, props, ref3, value;
                        props = this.properties;
                        if (this.generated) {
                            for (j = 0, len1 = props.length; j < len1; j++) {
                                node = props[j];
                ...
                exports.Assign = Assign = (function (superClass1) {
                    ...
                    Assign.prototype.compileNode = function (o) {
                        var answer, compiledName, isValue, j, name, properties, prototype, ref3, ref4, ref5, ref6, ref7,
                            ref8, val, varBase;
                    ...
                    Assign.prototype.compilePatternMatch = function (o) {
                        var acc, assigns, code, defaultValue, expandedIdx, fragments, i, idx, isObject, ivar, j, len1,
                            message, name, obj, objects, olen, ref, ref3, ref4, ref5, ref6, rest, top, val, value, vvar,
                            vvarText;
                        top = o.level === LEVEL_TOP;
                        value = this.value;
                ...
                exports.Code = Code = (function (superClass1) {
                    ...
                    Code.prototype.compileNode = function (o) {
                        var answer, boundfunc, code, exprs, i, j, k, l, len1, len2, len3, len4, len5, len6, lit, m, p,
                            param, params, q, r, ref, ref3, ref4, ref5, ref6, ref7, ref8, splats, uniqs, val, wasEmpty,
                            wrapper;
                ...
                exports.For = For = (function (superClass1) {
                    ...
                    For.prototype.compileNode = function (o) {
                        var body, bodyFragments, compare, compareDown, declare, declareDown, defPart, defPartFragments,
                            down, forPartFragments, guardPart, idt1, increment, index, ivar, kvar, kvarAssign, last,
                            lvar, name, namePart, ref, ref3, ref4, resultPart, returnResult, rvar, scope, source, step,
                            stepNum, stepVar, svar, varPart;
            ...
            (function () {
                ...
                SourceMap = (function () {
                    ...
                    SourceMap.prototype.generate = function (options, code) {
                        var buffer, i, j, lastColumn, lastSourceColumn, lastSourceLine, len, len1, lineMap, lineNumber,
                            mapping, needComma, ref, ref1, v3, writingline;
                        if (options == null) {
                            options = {};
                        }
                        if (code == null) {
        ...
        require['./coffee-script'] = (function () {
            ...
            // Generated by CoffeeScript 1.12.2
            (function () {
                var Lexer, SourceMap, base64encode, compile, ext, fn1, fs, helpers, i, len, lexer, packageJson, parser,
                    path, ref, vm, withPrettyErrors,
                    hasProp = {}.hasOwnProperty;
                ...
                exports.compile = compile = withPrettyErrors(function (code, options) {
                    var currentColumn, currentLine, encoded, extend, fragment, fragments, generateSourceMap, header, i,
                        j, js, len, len1, map, merge, newLines, ref, ref1, sourceMapDataURI, sourceURL, token, tokens,
                        v3SourceMap;
                ...
                exports["eval"] = function (code, options) {
                    var Module, _module, _require, createContext, i, isContext, js, k, len, o, r, ref, ref1, ref2, ref3,
                        sandbox, v;
                    if (options == null) {
                        options = {};
                    }
